...
import { ILSHAllowanceUtility } from "./interfaces/ILSHAllowanceUtility.sol";
...
contract LSHUtilityERC is Ownable, ILSHAllowanceUtility {
    ...
    fallback() external payable {
        emit LSHAllowanceUtilityEvent(msg.sender, msg.value, "Fallback Called");
    }
}