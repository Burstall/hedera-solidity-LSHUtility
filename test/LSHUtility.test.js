...
const { contractExecuteFunction, linkBytecode, contractDeployFunction } = require('../utils/solidityHelpers');
...
describe('Deployment: ', function() {
	it('Should deploy the contract and setup conditions', async function() {
		...
		[contractId, contractAddress] = await contractDeployFunction(client, readyToDeployBytecode, gasLimit);
